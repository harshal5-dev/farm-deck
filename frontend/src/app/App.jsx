...
import { FieldsList, AddField, EditField } from "@/features/fields";
import {
  CropsList,
  AddCrop,
  EditCrop,
...
import { HarvestsList, AddHarvest, EditHarvest } from "@/features/harvests";
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route path="/app" element={<Layout />}>
              ...
              <Route
                path="crops/cycle/:cycleId/logs"
                element={<DailyLogsList />}
              />
              <Route
                path="crops/cycle/:cycleId/logs/new"
                element={<AddDailyLog />}
              />
              <Route
                path="crops/cycle/:cycleId/logs/edit"
                element={<EditDailyLog />}
              />
              {/* Harvest routes */}
