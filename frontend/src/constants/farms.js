...
export const FARM_TYPES = {
  ...
  greenhouse: {
    ...
    gradient: "from-sky-warm to-sage",
    chip: "from-sky-warm/20 to-sage/10 text-lagoon-deep dark:text-sky-warm ring-sky-warm/25",
  },
  mixed: {
    id: "mixed",
    icon: IconPlant2,
  ...
  indoor: {
    ...
    textBright: "text-iris-deep",
    bg: "bg-iris/12 dark:bg-iris/15",
    bgSoft: "bg-iris/8",
    ring: "ring-iris/40",
    border: "border-iris/30",
    gradient: "from-iris to-plum",
    chip: "from-iris/20 to-plum/10 text-iris-deep dark:text-iris ring-iris/25",
  },
};
...
export const SOIL_TYPES = {
  ...
  chalky: {
    ...
    icon: IconGrain,
    gradient: "from-sky-warm to-wheat",
  },
  peaty: {
    name: "peaty",
    label: "Peaty",
