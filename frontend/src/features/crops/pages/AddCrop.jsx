...
const AddCrop = () => {
  ...
  // Only roles that can manage crops should reach this form.
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      toast.success("Crop planned", {
        description: `${created.name} is set up on ${created.zoneName}.`,
      });
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-muted-foreground sm:text-xs">
                  Pick a field, choose the crop, set the dates. Advance the
                  cycle as it grows.
                </p>
              </div>
            </div>
