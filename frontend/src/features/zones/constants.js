...
export const ZONE_TYPES = {
  ...
  hydro: {
    ...
    chip: "from-sky-warm/20 to-lagoon/10 text-lagoon-deep dark:text-lagoon ring-lagoon/25",
  ...
  aquaponic: {
    ...
    gradient: "from-lagoon to-iris-deep",
    chip: "from-iris/20 to-lagoon/10 text-iris-deep dark:text-iris ring-iris/25",
  ...
  mushroom: {
    ...
    icon: IconMushroom,
    art: "mushroom",
    text: "text-plum-deep dark:text-plum",
    bg: "bg-plum/12 dark:bg-plum/15",
    bgSoft: "bg-plum/8",
    ring: "ring-plum/40",
    border: "border-plum/30",
    gradient: "from-plum to-plum-deep",
    chip: "from-plum/20 to-plum/5 text-plum-deep dark:text-plum ring-plum/25",
    glow: "hover:shadow-plum/25",
  },
};
