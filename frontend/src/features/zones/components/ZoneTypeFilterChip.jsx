...
/**
 * Filter chip for a zone-type lookup row. `typeName` is the lookup
 * `name` (e.g. "hydro") used to resolve the visual config; `label` is
 * the user-facing displayName.
 */
const ZoneTypeFilterChip = ({ typeName, label, count, active, onClick }) => {
...
export default ZoneTypeFilterChip;
