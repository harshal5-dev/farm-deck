...
const FarmActionMenu = ({
  ...
  const copyName = () => {
    setMenuOpen(false);
    navigator.clipboard?.writeText(farm.name);
    toast.success("Farm name copied", { description: farm.name });
  };
      ...
      <Popover open={menuOpen} onOpenChange={setMenuOpen}>
        ...
        <PopoverContent align="end" sideOffset={6} className="w-56 gap-0 p-1.5">
          {canManage && (
            ...
            >
              <span
                className={`flex size-7 items-center justify-center rounded-md ${t.bg} ${t.text}`}
              >
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-medium text-foreground">Copy name</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <DialogDescription className="mt-1">
                  ...
                  will be permanently removed from the workspace. This action
                  cannot be undone.
                </DialogDescription>
              </div>
            </div>
