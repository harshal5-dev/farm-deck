...
import { useCreateFarmMutation } from "../farmApi";
...
const AddFarm = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      toast.error("Could not add farm", {
        description: err?.data?.error?.message || "Please try again.",
      });
    }
  };

  const handleCancel = () => navigate("/app/farms");
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-muted-foreground sm:text-xs">
                  Name it, pick a type, drop a pin. You can edit anything later.
                </p>
              </div>
            </div>
